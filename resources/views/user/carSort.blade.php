        ...
        <div class="container mt-4">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="top">
                        <div>
                            <a href="{{ '/' }}">Home</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="{{route('users.view.cars')}}">Buy Car</a>
                        </div>
                        <div>
                            @if (Auth::user())
                            <form action="{{ route('cars.sort') }}" method="get">
                                <select class="short" name="sort_by" onchange="this.form.submit()">
                                    <option value="" @if(empty($sortBy)) selected @endif>SORT BY</option>
                                    ...
                                    <option value="Km(Low to High)" @if($sortBy == 'Km(Low to High)') selected @endif>Km(Low to High)</option>
                                    <option value="Km(High to Low)" @if($sortBy == 'Km(High to Low)') selected @endif>Km(High to Low)</option>
                                    <option value="Year Ascending" @if($sortBy == 'Year Ascending') selected @endif>Year Ascending</option>
                                    <option value="Year Descending" @if($sortBy == 'Year Descending') selected @endif>Year Descending</option>
                                </select>
                            </form>
                    ...
                    <h4 class="mb-5">{{ $sortedCars->count() }} Used Cars in Bhubaneswar for sale!</h4>
                        ...
                        @foreach ($sortedCars as $car)
                            <div class="col-md-6 mb-4">
                                <div class="card shadow">
                                    ...
                                    <div class="icon">
                                        <i class="fa-solid fa-heart"></i>&nbsp;&nbsp;<i class="fa-solid fa-share-nodes"
                                            style="color: #981b64;"></i>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="rate">
                                            <p class="card-text"><span class="fs-4">&#8377;
                                                    ...
                                                    <h4 class="rating" data-rating="{{ $averageRatings[$car->id] }}">
                                                        @php
                                                            $roundedRating = round($averageRatings[$car->id]);
                                                        @endphp
                                        ...
                                        <a href="contact.php" class="btn btn-primary m-2"
                                            style="background-color:#a11a58">Book Now</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
