...
@section('content')
    ...
    <div class="ms-3" style="height: 32rem;overflow-y:scroll">
        <form action="{{ route('admin.contact.send', ['id' => $contacts->id] )}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Email address</label>
                <input type="email" class="form-control fs-4" id="exampleInputEmail1" aria-describedby="emailHelp"
                    name="email" value="{{ $contacts->email }}" readonly>
            ...
            <div class="d-flex justify-content-center mt-5">
                ...
                <a href="{{ route('admin.contact.view') }}"><button type="button" class="btn btn-primary btn-lg ms-4">View
                        Enquiries</button></a>
            </div>
